...
void SendMessage()
{
  ...
  mySerial.println("AT+CMGS=\"+919407711523\"\r"); // Replace x with mobile number
  delay(1000);
...
void MakeCall()
{
  mySerial.println("ATD+919407711523;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!
